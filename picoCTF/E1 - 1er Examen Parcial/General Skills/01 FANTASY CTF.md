...
**Description**
	...
	Connect to the program with netcat:`$ nc verbal-sleep.picoctf.net 56890`
	**Hints**
		1. When a choice is presented like [a/b/c], choose one, for example: `c` and then press Enter.

**Solution**
	1. Usando terminal de picoCTF
		Lui5-picoctf@webshell:~$ nc verbal-sleep.picoctf.net 56890
...
**Notes**
	- En este reto, cada vez que te presentan opciones `[a/b/c]` o `[a/b]`, **la historia te da pistas sobre cuál elegir**.
	- Siempre elegir la opción correcta evita descalificación o errores.
	- “Press Enter” avanza la historia, no afecta la flag.
	- La flag está en la historia después de completar el juego interactivo.
